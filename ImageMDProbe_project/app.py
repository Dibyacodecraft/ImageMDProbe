...
model = tf.keras.models.load_model(os.path.join(app.root_path, 'model', 'skin_disease_model.h5'))
# NOTE: Place your trained model file `skin_disease_model.h5` inside the `model/` folder in this project.
